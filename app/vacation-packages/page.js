    ...
    <>
      ...
      <main>
        <section className="landing-hero section-pad">
          <div className="landing-copy"><p className="eyebrow">Florida vacation discovery</p><h1>Build A Complete Florida Vacation</h1><p className="hero-subhead">Compare complete trip ideas across cruises, hotels, flights, local activities, destinations, budgets, and travel styles.</p><div className="hero-actions"><a href="#package-finder-title">Search vacation packages</a><Link href="/florida-vacation-planning-guide">Plan a Florida trip</Link></div></div>
